...
//   }
//
//   // void recordMemo() async {
//   //   bool isRecording = await Record.hasPermission();
//   //   if (!isRecording) {
//   //     // Request permission to record audio
//   //     await Record.requestPermission();
//   //     isRecording = await Record.hasPermission();
//   //   }
//   //
//   //   if (isRecording) {
//   //     // Start recording
//   //     String path = 'path_to_save_audio_file'; // Specify the path where you want to save the audio file
...
//   //       String path = 'path_to_save_audio_file';
//   //       await Record.start(path: path);
//   //       print('Recording...');
//   //     } else {
//   //       print('Permission to record audio denied.');
