...
import 'package:dear_diary_with_firebase_auth_storage_database/view/diary_list_view2.dart';
...
class NewEntryView2 extends StatefulWidget {
  bool isDark;

  NewEntryView2.withInheritedTheme(this.isDark);
...
class _NewEntryViewState extends State<NewEntryView2> {
  ...
  var diaryController = DiaryController2();
  ...
  void _saveDiaryEntry() async {
    ...
    DiaryModel2 diaryEntry = DiaryModel2(
    ...
    try {
      if (successfullyAdded) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => DiaryLogView2.WithPersistedTheme(isDark)),
        );
